...
namespace Cinema.Migrations
{
    ...
    public partial class HELP : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            //        Description = table.Column<string>(type: "nvarchar(max)", nullable: false),
            //        For_what = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            //    constraints: table =>
            //    {
            //        table.PrimaryKey("PK_SaleSnack", x => new { x.SalesId, x.SnacksId });
            //        table.ForeignKey(
            //            name: "FK_SaleSnack_Sales_SalesId",
            //            column: x => x.SalesId,
            //            principalTable: "Sales",
            //            principalColumn: "Id",
            //            onDelete: ReferentialAction.Cascade);
            //        table.ForeignKey(
            //            name: "FK_SaleSnack_Snacks_SnacksId",
            //            column: x => x.SnacksId,
        ...
        //            Price = table.Column<int>(type: "int", nullable: false),
        //            Book_buy_data = table.Column<DateTime>(type: "datetime2", nullable: false),
        ...
        //        constraints: table =>
        //        {
        //            table.PrimaryKey("PK_SaleTicket", x => new { x.SalesId, x.TicketsId });
        //            table.ForeignKey(
        //                name: "FK_SaleTicket_Sales_SalesId",
        //                column: x => x.SalesId,
        //                principalTable: "Sales",
        //                principalColumn: "Id",
        //                onDelete: ReferentialAction.Cascade);
        //            table.ForeignKey(
        //                name: "FK_SaleTicket_Tickets_TicketsId",
        ...
        //    migrationBuilder.CreateIndex(
        //        name: "IX_SaleSnack_SnacksId",
        //        table: "SaleSnack",
        //        column: "SnacksId");

        //    migrationBuilder.CreateIndex(
        //        name: "IX_SaleTicket_TicketsId",
        //        table: "SaleTicket",
        //        column: "TicketsId");
